...
def is_hiragana(surface: str) -> bool:
    global _re_hiragana
...
def is_katakana(surface: str) -> bool:
    global _re_katakana
...
def is_letter(surface: str) -> bool:
    global _re_letter
...
def is_symbol(surface: str) -> bool:
    global _re_symbol
...
def has_longvowel(text: str) -> bool:
